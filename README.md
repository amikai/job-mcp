...
This server can consume a lot of tokens, especially when your client explores
multiple postings or fetches full job details. Use a cheaper fast model such as
Gemini Flash or Claude Haiku when possible, and keep `effort` low.
