...
type SearchRequest struct {
	...
	Page    int                 `json:"page"`
	Locale  SearchRequestLocale `json:"locale"`
	Sort    SearchRequestSort   `json:"sort"`
...
func (s *SearchRequest) GetPage() int {
	return s.Page
}

// GetLocale returns the value of Locale.
func (s *SearchRequest) GetLocale() SearchRequestLocale {
	return s.Locale
}

// GetSort returns the value of Sort.
func (s *SearchRequest) GetSort() SearchRequestSort {
	return s.Sort
}

// GetFormat returns the value of Format.
func (s *SearchRequest) GetFormat() DateFormat {
	return s.Format
}
...
func (s *SearchRequest) SetFilters(val SearchFilters) {
	s.Filters = val
}

// SetPage sets the value of Page.
func (s *SearchRequest) SetPage(val int) {
	s.Page = val
}

// SetLocale sets the value of Locale.
func (s *SearchRequest) SetLocale(val SearchRequestLocale) {
	s.Locale = val
}

// SetSort sets the value of Sort.
func (s *SearchRequest) SetSort(val SearchRequestSort) {
	s.Sort = val
}

// SetFormat sets the value of Format.
func (s *SearchRequest) SetFormat(val DateFormat) {
	s.Format = val
}

type SearchRequestLocale string

const (
	SearchRequestLocaleEnUs SearchRequestLocale = "en-us"
)

// AllValues returns all SearchRequestLocale values.
func (SearchRequestLocale) AllValues() []SearchRequestLocale {
	return []SearchRequestLocale{
		SearchRequestLocaleEnUs,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s SearchRequestLocale) MarshalText() ([]byte, error) {
	switch s {
	case SearchRequestLocaleEnUs:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *SearchRequestLocale) UnmarshalText(data []byte) error {
	switch SearchRequestLocale(data) {
	case SearchRequestLocaleEnUs:
		*s = SearchRequestLocaleEnUs
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
const (
	SearchRequestSortRelevance SearchRequestSort = "relevance"
	SearchRequestSortNewest    SearchRequestSort = "newest"
)

// AllValues returns all SearchRequestSort values.
func (SearchRequestSort) AllValues() []SearchRequestSort {
	return []SearchRequestSort{
		SearchRequestSortRelevance,
		SearchRequestSortNewest,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s SearchRequestSort) MarshalText() ([]byte, error) {
	switch s {
	case SearchRequestSortRelevance:
		return []byte(s), nil
	case SearchRequestSortNewest:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *SearchRequestSort) UnmarshalText(data []byte) error {
	switch SearchRequestSort(data) {
	case SearchRequestSortRelevance:
		*s = SearchRequestSortRelevance
		return nil
	case SearchRequestSortNewest:
		*s = SearchRequestSortNewest
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
