...
// Encode encodes SearchRequestLocale as json.
func (s SearchRequestLocale) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes SearchRequestLocale from json.
func (s *SearchRequestLocale) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode SearchRequestLocale to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s SearchRequestLocale) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *SearchRequestLocale) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
