...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		switch elem[0] {
		case '/': // Prefix: "/remote-jobs"

			if l := len("/remote-jobs"); len(elem) >= l && elem[0:l] == "/remote-jobs" {
				elem = elem[l:]
			} else {
				break
			}
		...
		case '/': // Prefix: "/remote-jobs"
			...
			if len(elem) == 0 {
				...
				case "GET":
					...
					r.summary = "Full dump of currently listed remote jobs"
					r.operationID = "listJobs"
					r.operationGroup = ""
					r.pathPattern = "/remote-jobs"
					r.args = args
					r.count = 0
					return r, true
				default:
			...
			case '/': // Prefix: "/categories"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "List job categories"
						r.operationID = "listCategories"
						r.operationGroup = ""
						r.pathPattern = "/remote-jobs/categories"
						r.args = args
						r.count = 0
						return r, true
					default:
